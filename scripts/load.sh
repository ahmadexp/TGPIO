...
EXPERIMENTAL_INSTANTANEOUS_REALTIME_PROJECTION="${EXPERIMENTAL_INSTANTANEOUS_REALTIME_PROJECTION:-0}"
...
OUTPUT_PHASE_TOLERANCE_NS="${OUTPUT_PHASE_TOLERANCE_NS:-0}"
...
insmod "${MODULE}" addr0="${ADDR0}" addr1="${ADDR1}" mmio_size="${MMIO_SIZE}" \
	...
	experimental_instantaneous_realtime_projection="${EXPERIMENTAL_INSTANTANEOUS_REALTIME_PROJECTION}" \
