...
under **System devices** and loads the custom icon bundled with the driver package:

![TGPIO custom icon in Windows Device Manager](../assets/windows-device-manager-tgpio.png)
